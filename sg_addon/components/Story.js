...
export default class Story extends React.Component {
    ...
    componentDidMount() {
//    console.log('info did mount:', this.srCode.textContent);
        if (this.props.getCode && this.srCode) {
            this.props.getCode(this.srCode.textContent);
        }
    }
    ...
    _getSourceCode() {
        ...
        return (
          <div>
            ...
            <Pre getRef={(ref) => { this.srCode = ref; }}>
